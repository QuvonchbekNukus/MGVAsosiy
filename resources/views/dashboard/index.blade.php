...
<head>
    ...
    <link rel="shortcut icon" href="{{ asset('assets/mgvlogo.png') }}" type="image/x-icon">
...
<body>
    ...
    <div id="app">
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="logo">
                            <a href="{{ route('dashboard.index') }}">
                                <img src="{{ asset('assets/mgvlogo.png') }}" alt="MILLIYA GVARDIYA" srcset=""
                                    style="max-width: 100px; height: auto;">
                            </a>
                            <br>
                            <span class="sitename">e-gvardiya</span>
                        </div>
                        <div class="theme-toggle d-flex gap-2 align-items-start mt-2"
        ...
        <div id="main">
            <header class="mb-3 border-bottom py-3">
                <div class="d-flex justify-content-between align-items-center px-4">
                    ...
                    <div class="dropdown ms-auto">
                        <button class="btn btn-outline-secondary dropdown-toggle d-flex align-items-center gap-2" type="button" id="userMenuDropdown" data-bs-toggle="dropdown" aria-expanded="false">
                            <img src="{{ asset('./assets/compiled/jpg/1.jpg') }}" alt="avatar" class="rounded-circle" style="width: 32px; height: 32px; object-fit: cover;">
                            <span class="d-none d-md-inline">User Account</span>
                        </button>
